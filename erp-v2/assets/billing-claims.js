(() => {
  ...
  function documentHtml(rows){
    return`<!doctype html><html lang="zh-TW"><head><meta charset="utf-8"><title>社區請款單</title><style>
      ...
      body{font-size:10.5px}.claim-page{height:287mm;padding:3mm 4mm}.claim-copy{height:138.5mm;padding:4mm 5mm}header{gap:12px;padding-bottom:5px;margin-bottom:6px}header h1{font-size:15px}header h2{font-size:18px;letter-spacing:4px}header p{font-size:9px}.copy-label{font-size:14px;padding:5px 9px}.claim-meta{gap:4px 12px;margin-bottom:5px}.claim-meta p{padding:3px}th,td{padding:3px 5px;line-height:1.22}.items .total{font-size:13px}.tax-note{font-size:9.5px}.payment,.notes{padding:5px 7px}.payment h3{font-size:10.5px}footer{font-size:10px;margin-top:13px}.cut-line{height:4mm;margin-top:2mm}
