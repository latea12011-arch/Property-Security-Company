(() => {
  ...
  function documentHtml(rows){
    return`<!doctype html><html lang="zh-TW"><head><meta charset="utf-8"><title>社區請款單</title><style>
      @page{size:A4 portrait;margin:0}*{box-sizing:border-box}html,body{margin:0;width:210mm;background:#fff;color:#111;font-family:"DFKai-SB","BiauKai","Microsoft JhengHei",sans-serif}body{font-size:10.5px}.claim-page{width:210mm;height:297mm;padding:4mm 8mm;overflow:hidden;break-after:page}.claim-page:last-child{break-after:auto}.claim-copy{height:140.5mm;display:grid;grid-template-columns:minmax(0,1fr) 9mm;overflow:hidden}.claim-main{min-width:0;display:flex;flex-direction:column}.claim-main>header{flex:0 0 auto;padding:1mm 2mm 1.8mm;text-align:center}.claim-main>header h1{margin:0;font-size:18px;letter-spacing:2px}.title-row{position:relative;margin-top:2px}.title-row h2{margin:0;font-size:17px;letter-spacing:7px}.title-row time{position:absolute;right:2mm;bottom:1px;font-size:11px;font-weight:700}.claim-main>header>p{margin:3px 0 0;font-size:8.5px;letter-spacing:.2px}.copy-label{align-self:stretch;display:flex;align-items:center;justify-content:center;border:1.4px solid #111;border-left:0;font-size:14px;letter-spacing:5px;writing-mode:vertical-rl;text-orientation:upright}.service-form{width:100%;height:86mm;border-collapse:collapse;table-layout:fixed}.service-form th,.service-form td{border:1.4px solid #111}.service-form>tbody>tr>th{width:26mm;padding:2mm;text-align:center;font-size:14px;letter-spacing:2px}.service-form>tbody>tr>td{padding:2mm 2.5mm}.amount-row{height:14mm}.amount-row td{height:14mm;font-size:14px}.amount-value{display:flex;align-items:center;justify-content:space-between;gap:8px}.amount-value>strong{letter-spacing:5px}.amount-value>span{white-space:nowrap;font-family:"Microsoft JhengHei",sans-serif;font-weight:800}.summary-row{height:55mm}.summary-row>td{position:relative;vertical-align:top}.summary-info{display:grid;grid-template-columns:1fr 1fr;gap:2px 14px;font-size:10px}.summary-info p{margin:0;line-height:1.5}.summary-info p:first-child,.summary-info p:nth-child(2){grid-column:1/-1}.item-list{display:grid;grid-template-columns:1fr 1fr;gap:2px 14px;margin:4px 0 3px;padding:0;list-style:none;font-family:"Microsoft JhengHei",sans-serif;font-size:9px}.item-list li{display:flex;justify-content:space-between;gap:6px;border-bottom:1px dotted #777}.item-list strong{white-space:nowrap}.amount-summary{width:58%;margin:2px 0 0 auto;border-collapse:collapse;font-family:"Microsoft JhengHei",sans-serif}.amount-summary th,.amount-summary td{border:1px solid #111;padding:2px 5px}.amount-summary th{width:55%;text-align:right}.amount-summary td{text-align:right}.amount-summary td span{float:left}.amount-summary .total{font-size:11px}.tax-note{display:block;margin-top:2px;text-align:right;font-family:"Microsoft JhengHei",sans-serif;font-size:8px}.remarks-row{height:17mm}.remarks-row td{vertical-align:top}.claim-notes{margin:0 0 3px;white-space:pre-wrap;font-size:9px}.payment{display:grid;grid-template-columns:1fr 1.35fr;gap:1px 12px;font-size:9.5px;line-height:1.45}.payment p{margin:0}.payment p:first-child{grid-column:1/-1}.claim-main>footer{flex:1 1 auto;min-height:25mm;display:grid;grid-template-columns:1fr .75fr 1.15fr}.claim-main>footer>div{border:1.4px solid #111;border-top:0;padding:2.5mm;font-size:11px}.claim-main>footer>div+div{border-left:0}.company-stamp{min-width:0}.cut-line{height:8mm;border-top:1px dashed #555;position:relative}.cut-line span{position:absolute;top:-8px;left:2mm;padding:0 3px;background:#fff;color:#555}@media print{body{print-color-adjust:exact;-webkit-print-color-adjust:exact}}
